...
const Map = ({ miners }) => {
  ...
  console.log({hover, hoverMiner})
  return (
    <div className="no-scrollbar relative min-h-[60vh] overflow-scroll">
      <div className="absolute left-[150px] top-10 z-10 h-[492px] w-[900px]">
        <img src="/map.png" className="h-[492px] w-[900px]" />
        <div className="absolute left-[310px] top-[112px] z-50">
              ...
              .map((m, index) => {
                return (
                  ...
                  />
                  {
                    ...
                    <p className="bg-mainBrown border border-primary rounded-md p-4 text-white/60 absolute">{m.name}</p>
                  }
                  </div>
                );
              })}
        ...
        <div className="z-60 absolute left-[300px] top-[337px]">
